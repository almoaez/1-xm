/*
blog : www.1-xm.blogspot.com
name :almoaz
*/
$(".btnclose").click(function(){$("#almoaz-download,.btnclose").remove(),$(".btneffect").text(text).toggleClass("reload").attr("onclick","history.go(0)")}),$(".btneffect").click(function(){function t(){if("1"==$(".count_direct_link .countdownnumber .count").text()){if($(".directdownloadlink").show(),d-=1,-1>=d){d=n
